...
## Project Structure
    ...
    ├── testapiautostoryboa_90335  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_90335`
...
2. Clone this repo and `cd testapiautostoryboa_90335`
